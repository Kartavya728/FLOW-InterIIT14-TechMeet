...
# The script uses the currently active Python environment (e.g., conda activate pathway_env)
# No venv activation needed - just verify we have python3
if ! command -v python3 &> /dev/null; then
    echo "Error: python3 not found. Please activate your conda environment first:"
    echo "  conda activate pathway_env"
    exit 1
fi
echo "Python env: $(which python3)"
