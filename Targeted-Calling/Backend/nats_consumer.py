...
# WebSocket notification URL (use localhost in container since backend is same service)
BACKEND_HOST = os.getenv("BACKEND_HOST", "localhost")
BACKEND_PORT = os.getenv("BACKEND_PORT", "5000")
WEBSOCKET_NOTIFY_URL = f"http://{BACKEND_HOST}:{BACKEND_PORT}/api/notify-update"
...
async def subscribe_to_batches():
    ...
    try:
        ...
        print(f"✅ Connected to NATS server at {NATS_URI}")
